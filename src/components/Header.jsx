...
const Header = () => {
  ...
  return (
    <div className="w-full h-[6rem]">
      <div className="w-full h-[50%] text-white font-semibold bg-[#000009] flex justify-center max-lg:gap-3 max-md:justify-around items-center">
        <div className="w-[4%] h-full  flex justify-center items-center max-md:w-[10%]">
          <img src={arrow} alt="" width={25} />
        </div>
        <div className=" w-[50%] h-full flex justify-center  max-lg:w-[50%] items-center max-md:w-[50%] ">
          <p className=" max-md:text-[10px] text-center">
            Nov 8th, 10AM PT | Fine-Tuning OpenAI’s GPT 3.5 to Unlock Enterprise
            Use Cases
          </p>
        </div>
        <nav className="w-[9%] h-full max-lg:w-[15%] cursor-pointer max-md:text-[10px] flex justify-center gap-1 items-center max-md:w-[16%]">
      ...
      <div className="w-full h-[50%] border-slate-600 border-b bg-[#00000f] flex justify-around items-center max-md:justify-between px-7">
        ...
        <div className="w-[48%] h-full max-md:hidden  max-lg:w-[70%]  font-semibold text-white flex justify-around items-center">
          <nav>Products</nav>
          <nav>Governments</nav>
          <nav>Solutions</nav>
          <nav>Customers</nav>
        ...
        <div className="w-[18%] h-full flex justify-around items-center max-md:hidden max-lg:w-[10%]">
          <button className="flex justify-center max-lg:hidden font-semibold text-white items-center gap-2 px-3 py-2 rounded-md bg-custom-gradient">
            Book a Demo <FaArrowRight className=" max-lg:hidden" />
          </button>
