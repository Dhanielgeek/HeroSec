...
const Hero = () => {
  ...
  return (
    <div className="Hero_img w-full h-[50rem] bg-[#00000f] flex-col flex justify-center items-center">
      <div className="w-[60%] h-[60%]  flex justify-center space-y-8 items-center flex-col max-md:w-[90%]">
        <h2 className=" text-6xl text-center font-bold text-white max-md:text-2xl">
          Power{" "}
        ...
        <p className=" text-xl text-center text-white font-medium max-md:text-sm">
        ...
        <div className="w-[60%] h-[10%]  flex justify-center items-center gap-2 ">
          <button className=" max-md:px-1 flex justify-center items-center px-3 py-2 bg-custom-gradient rounded text-white font-semibold gap-2">
